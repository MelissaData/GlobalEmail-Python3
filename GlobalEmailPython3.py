...
def main():
  base_service_url = "https://globalemail.melissadata.net/"
  service_endpoint = "v4/WEB/GlobalEmail/doGlobalEmail"

  # Create an ArgumentParser object
  parser = argparse.ArgumentParser(description='Global Email command line arguments parser')
  ...
  call_api(base_service_url, service_endpoint, license, email)
...
def call_api(base_service_url, service_endpoint, license, email):
